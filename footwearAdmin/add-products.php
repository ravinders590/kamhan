          ...
          <div class="card-body">
            <form action="" method="post"  enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="file" id="main" name="product_photo[]" class="form-control" required="" multiple>
              </div>
              <!-- <div class="form-group">
                <fieldset class="fieldset">
                        ...
                        foreach ($obj_view as $key => $obj_views) {
                          if ($obj_views['status'] != 0) {
                           ...
                           <tr>
                              ...
                              <td><?php echo $obj_views['productmaterial']; ?></td>
                              <td>
                              <?php
                              $product_photo = unserialize($obj_views['product_photo']);
                              ...
                              $youtube_videos = explode(',',$youtube_videos[0]);
                                for ($i=0; $i < count($youtube_videos) ; $i++) { 
                                  if (preg_match('/embed/',$youtube_videos[$i]) === 1 || preg_match('/youtu.be/',$youtube_videos[$i]) === 1) {
                                    ...
                                    ?>
                                    <iframe width="100" height="100" src="<?php echo $youtube_video; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
                                    <?php
